...
<body>
    ...
    <div class="container">
        <section class="container my-4">
            <x-bootstrap-flash-messages />
        </section>

        <h3 class=" text-center">Morento Chat Room</h3>
        <div class="messaging">
            <div class="inbox_msg">
                        ...
                        <a href="/chat/room/{{$message->user->id}}">
                            <div class="chat_list active_chat">
                                <div class="chat_people">
                                    <div class="chat_img"> @if ($message->user->role_id == 2)
                                    ...
                                    <div class="chat_ib">
                                        <h5>{{$message->user->name}} <span
                                                class="chat_date">{{$message->created_at->diffForHumans()}}</span></h5>
                                        <p>{{$message->message}}</p>
                                    </div>
                                </div>
                            </div>
